...
public class ItemTagProvider extends FabricTagProvider.ItemTagProvider {
	...
	protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
		...
		addColored(tag(Tags.Items.DYES)::addTag);
	...
	private void addColored(Consumer<TagKey<Item>> consumer) {
		String prefix = Tags.Items.DYES.id().getPath().toUpperCase(Locale.ENGLISH) + '_';
		for (DyeColor color : DyeColor.values()) {
			Identifier key = Identifier.of("minecraft", "{color}_dye".replace("{color}", color.getName()));
