...
public class ModCreativeTabs {
    ...
    public static ItemGroup ATTACHMENT_SCOPE_TAB = register("scope", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "sight_sro_dot"))
                    .build(AttachmentType.SCOPE))
    ...
    public static ItemGroup ATTACHMENT_MUZZLE_TAB = register("muzzle", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "muzzle_compensator_trident")).build(AttachmentType.MUZZLE))
    ...
    public static ItemGroup ATTACHMENT_STOCK_TAB = register("stock", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "stock_militech_b5")).build(AttachmentType.STOCK))
    ...
    public static ItemGroup ATTACHMENT_GRIP_TAB = register("grip", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "grip_magpul_afg_2")).build(AttachmentType.GRIP))
    ...
    public static ItemGroup ATTACHMENT_EXTENDED_MAG_TAB = register("extended_mag", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "extended_mag_3")).build(AttachmentType.EXTENDED_MAG))
    ...
    public static ItemGroup GUN_PISTOL_TAB = register("pistol", FabricItemGroup.builder()
            ...
            .icon(() -> GunItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "glock_17")).build())
    ...
    public static ItemGroup GUN_SNIPER_TAB = register("sniper", FabricItemGroup.builder()
            ...
            .icon(() -> GunItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "ai_awp")).build())
    ...
    public static ItemGroup GUN_RIFLE_TAB = register("rifle", FabricItemGroup.builder()
            ...
            .icon(() -> GunItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "ak47")).build())
    ...
    public static ItemGroup GUN_SHOTGUN_TAB = register("shotgun", FabricItemGroup.builder()
            ...
            .icon(() -> GunItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "db_short")).build())
    ...
    public static ItemGroup GUN_SMG_TAB = register("smg", FabricItemGroup.builder()
            ...
            .icon(() -> GunItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "hk_mp5a5")).build())
    ...
    public static ItemGroup GUN_RPG_TAB = register("rpg", FabricItemGroup.builder()
            ...
            .icon(() -> GunItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "rpg7")).build())
    ...
    public static ItemGroup GUN_MG_TAB = register("mg", FabricItemGroup.builder()
            ...
            .icon(() -> GunItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "m249")).build())
    ...
    private static ItemGroup register(String path, ItemGroup group) {
        return Registry.register(Registries.ITEM_GROUP, Identifier.of(GunMod.MOD_ID, path), group);
    }
}
