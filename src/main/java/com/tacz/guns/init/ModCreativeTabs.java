...
public class ModCreativeTabs {
    ...
    public static ItemGroup ATTACHMENT_SCOPE_TAB = register("scope", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "sight_sro_dot")).build())
    ...
    public static ItemGroup ATTACHMENT_MUZZLE_TAB = register("muzzle", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "muzzle_compensator_trident")).build())
    ...
    public static ItemGroup ATTACHMENT_STOCK_TAB = register("stock", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "stock_militech_b5")).build())
    ...
    public static ItemGroup ATTACHMENT_GRIP_TAB = register("grip", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "grip_magpul_afg_2")).build())
    ...
    public static ItemGroup ATTACHMENT_EXTENDED_MAG_TAB = register("extended_mag", FabricItemGroup.builder()
            ...
            .icon(() -> AttachmentItemBuilder.create().setId(Identifier.of(GunMod.MOD_ID, "extended_mag_3")).build())
